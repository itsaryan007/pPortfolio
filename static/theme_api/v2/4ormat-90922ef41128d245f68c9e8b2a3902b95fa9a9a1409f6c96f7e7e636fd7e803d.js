...
_4ORMAT.ImageProtection = {
  init: function () {
    if (_4ORMAT.ImageProtection.is_enabled()) {
      ...
      _4ORMAT
        .$("body")
        .delegate("img", "contextmenu", _4ORMAT.ImageProtection.trap);
      _4ORMAT
        .$("body")
        .delegate(
          ".image-placeholder",
          "contextmenu",
          _4ORMAT.ImageProtection.trap
        );
      _4ORMAT
        .$("body")
        .delegate(
      ...
      _4ORMAT
        .$("body")
        .bind("mousedown", _4ORMAT.ImageProtection.remove_notice);
...
(function () {
  _4ORMAT.Share = (function () {
    ...
    $ = _4ORMAT.$;
    panelTemplate =
      '<div class="f-share-panel" role="dialog" aria-label="Share" tabindex="1"><div class="f-share-panel-arrow"><div class="f-share-panel-arrow-stroke"></div><div class="f-share-panel-arrow-fill"></div></div><div class="f-share-panel-content"></div></div>';
    analytics = null;
    availableNetworks = {
      facebook: {
    ...
    position = function () {
      var $content,
        ...
        leftDiff,
        link,
        offsetFromArrowToEdgeOfTooltip,
        offsetFromEdge,
        offsetFromLink,
        tooltip,
        top,
      ...
      $panel.removeClass(
        "f-share-panel-direction-top f-share-panel-direction-left f-share-panel-direction-right f-share-panel-direction-bottom"
      );
      win = {
        width: $(window).width(),
      ...
      dontGoOffScreenY = function () {
        ...
        if (/top|bottom/.test(direction)) {
          ...
          offBottomOfPage =
            link.top + link.height + tooltip.height > viewportBottom;
          if (offTopOfPage) {
            direction = "bottom";
          ...
          offTopOfPage =
            link.top + link.centerY - (tooltip.centerY + offsetFromEdge) < 0;
          offBottomOfPage =
            link.top + link.centerY + tooltip.centerY + offsetFromEdge >
            viewportBottom;
          if (offTopOfPage) {
      ...
      constrainToLink = function () {
        ...
        if (/left|right/.test(direction)) {
          ...
          min =
            ...
            arrow.centerY;
          max =
            absoluteCenterY - offsetFromArrowToEdgeOfTooltip - arrow.centerY;
          ...
          min =
            ...
            arrow.centerX;
          max =
            absoluteCenterX - offsetFromArrowToEdgeOfTooltip - arrow.centerX;
    ...
    constructLink = function (id) {
      ...
      network = availableNetworks[id];
      return $(
        "<a href='#' class='f-share-panel-network' data-network='" +
          id +
          "' tabindex='2'>" +
          network.label +
          "</a>"
    ...
    getVariables = function () {
      ...
      return {
        ...
        body_text_color: parseColor(
          (ref =
            (ref1 = theme.text_typography) != null ? ref1.color : void 0) !=
            null
            ? ref
    ...
    getStyles = function () {
      ...
      return (
        ...
        ", " +
        divider.b +
        ");\n  }\n  .f-share-panel-direction-top .f-share-panel-arrow-fill { border-top-color: rgb(" +
        fill.r +
        ", " +
        fill.g +
        ", " +
        fill.b +
        "); }\n  .f-share-panel-direction-top .f-share-panel-arrow-stroke { border-top-color: rgb(" +
        border.r +
        ", " +
        border.g +
        ", " +
        border.b +
        "); }\n  .f-share-panel-direction-left .f-share-panel-arrow-fill   { border-left-color: rgb(" +
        fill.r +
        ", " +
        fill.g +
        ", " +
        fill.b +
        "); }\n  .f-share-panel-direction-left .f-share-panel-arrow-stroke { border-left-color: rgb(" +
        border.r +
        ", " +
        border.g +
        ", " +
        border.b +
        "); }\n  .f-share-panel-direction-right .f-share-panel-arrow-fill   { border-right-color: rgb(" +
        fill.r +
        ", " +
        fill.g +
        ", " +
        fill.b +
        "); }\n  .f-share-panel-direction-right .f-share-panel-arrow-stroke { border-right-color: rgb(" +
        border.r +
        ", " +
        border.g +
        ", " +
        border.b +
        "); }\n  .f-share-panel-direction-bottom .f-share-panel-arrow-fill   { border-bottom-color: rgb(" +
        fill.r +
        ", " +
        fill.g +
        ", " +
        fill.b +
        "); }\n  .f-share-panel-direction-bottom .f-share-panel-arrow-stroke { border-bottom-color: rgb(" +
        border.r +
        ", " +
        border.g +
        ", " +
        border.b +
        "); }\n  .f-share-panel-network:link,\n  .f-share-panel-network:visited { color: rgba(" +
        text.r +
        ", " +
        text.g +
        ", " +
        text.b +
        ", 1.0) !important; }\n  .f-share-panel-network:link:hover { color: rgba(" +
        text.r +
        ", " +
        text.g +
        ", " +
  ...
  (function () {
    ...
    L.check = function () {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          ...
          if (
            !$.contains(document.documentElement, item[0][0]) ||
            item[0].data("lazyloadSlideshow")
          ) {
            continue;
          }
          elTop = item[1];
    ...
    L.checkOffsets = function () {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        ref1 = [
          L.images[priority][lastItemIndex],
          L.images[priority][randItemIndex],
        ];
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          item = ref1[k];
          offset = item[0].offset();
          vertDiff =
            item[1] - offset.top + item[2] - (offset.top + item[0].height());
          horDiff =
            item[3] - offset.left + item[4] - (offset.left + item[0].width());
          if (
            Math.abs(horDiff) > L.offsetErrorTolerance ||
            Math.abs(vertDiff) > L.offsetErrorTolerance
          ) {
            reset = true;
            break;
          }
